...
public class MithraPostgresTestAbstract extends MithraTestAbstract
{
    private MithraTestResource mithraTestResource;
    private String testDataFileName = "testdata/vendor/mithraPostgresTestData.txt";
    ...
    throws Exception
    {
        ...
        mithraTestResource = new MithraTestResource("MithraPostgresTestConfig.xml", PostgresDatabaseType.getInstance());
        mithraTestResource.setRestrictedClassList(getRestrictedClassList());

        PostgresTestConnectionManager connectionManager = PostgresTestConnectionManager.getInstance();
    ...
    {
        return PostgresTestConnectionManager.getInstance().getConnection();
    }
    ...
    protected void tearDown() throws Exception
    {
        ...
        if (!PostgresTestConnectionManager.getInstance().ensureAllConnectionsReturnedToPool())
        {
    ...
    protected void validateMithraResult(MithraList list, String sql, int minSize)
      {
          ...
          {
              getLogger().error("SQLException on MithraPostgresTestAbstract.validateMithraResult()",e);
