...
public class MithraDb2TestAbstract extends MithraTestAbstract
{
    private MithraTestResource mithraTestResource;
    private String testDataFileName = "testdata/vendor/mithraDb2TestData.txt";
    ...
    throws Exception
    {
        ...
        mithraTestResource = new MithraTestResource("MithraDb2TestConfig.xml", Udb82DatabaseType.getInstance());
        mithraTestResource.setRestrictedClassList(getRestrictedClassList());

        Db2TestConnectionManager connectionManager = Db2TestConnectionManager.getInstance();
    ...
    protected void tearDown() throws Exception
    {
        ...
        if (!Db2TestConnectionManager.getInstance().ensureAllConnectionsReturnedToPool())
        {
    ...
    protected void validateMithraResult(MithraList list, String sql, int minSize)
      {
          ...
          {
              getLogger().error("SQLException on MithraDb2TestAbstract.validateMithraResult()",e);
