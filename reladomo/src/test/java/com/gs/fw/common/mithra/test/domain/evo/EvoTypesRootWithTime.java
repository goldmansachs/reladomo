...
public class EvoTypesRootWithTime extends EvoTypesRootWithTimeAbstract
{
	public EvoTypesRootWithTime()
	{
		super();
	}

	protected EvoTypesRootWithTime(MithraObject ref, EvoTypesRootWithTimeExtractors attributes)
	{
		super(ref, attributes);
	}

    private EvoTypesRootWithTime(Builder builder)
    {
    ...
    public static class Builder
    {
        ...
        public EvoTypesRootWithTime build()
        {
            return new EvoTypesRootWithTime(this);
        }
