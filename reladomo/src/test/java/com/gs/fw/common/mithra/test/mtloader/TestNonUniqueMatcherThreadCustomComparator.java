...
import com.gs.fw.common.mithra.mtloader.NonUniqueMatcherThread;
import com.gs.fw.common.mithra.util.QueueExecutor;


public class TestNonUniqueMatcherThreadCustomComparator extends TestNonUniqueMatcherThread
{
    @Override
    ...
    {
        NonUniqueMatcherThread nonUniqueMatcherThread = new NonUniqueMatcherThread(bitemporalOrderExecutor, bitemporalOrderExtractor, INDEX_SIZE);
        nonUniqueMatcherThread.setComparator(COMPARATOR);
        return nonUniqueMatcherThread;
    }
