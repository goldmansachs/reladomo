...
public class TestNonUniqueMatcherThread extends MithraMatcherThreadTestAbstract
{
    @Override
    ...
    {
        return new NonUniqueMatcherThread(bitemporalOrderExecutor, bitemporalOrderExtractor, INDEX_SIZE);
    }
}