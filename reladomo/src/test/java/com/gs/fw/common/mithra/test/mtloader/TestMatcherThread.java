...
public class TestMatcherThread extends MithraMatcherThreadTestAbstract
{
    @Override
    ...
    {
        return new MatcherThread(bitemporalOrderExecutor, bitemporalOrderExtractor, INDEX_SIZE);
    }
}
