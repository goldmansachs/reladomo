...
public class TestOracleGeneralTestCases extends MithraOracleTestAbstract
{
    ...
    {
        new TestStandardDeviation(0.000002).testStdDevPopFloat();
    }
    ...
    {
        new TestVariance(0.000001).testVariancePopFloat();
    }
    ...
    {
        return OracleTestConnectionManager.getInstance().getSchemaName();
    }
    ...
    public void testRetrieveOneRow()
    {
        ...
        String sql = "select * from " + getSchemaName() + ".ALL_TYPES where ID = " +id;
     ...
     public void testLargeInClauseInParallel()
    {
        ...
        final String sql = "select * from " + getSchemaName() + ".ALL_TYPES where ID >= "+initialId;
    ...
    public void testBulkUpdate()
    {
        ...
        validateMithraResult(
                AllTypesFinder.findMany(AllTypesFinder.stringValue().eq("MultiUpdateTest")),
                "select * from ALL_TYPES where STRING_COL = 'MultiUpdateTest'",
                1000);
        ...
        validateMithraResult(
                AllTypesFinder.findMany(AllTypesFinder.nullableStringValue().eq("MultiUpdateTestNullable")),
                "select * from ALL_TYPES where NULL_STRING_COL = 'MultiUpdateTestNullable'",
                1000);
    }
    ...
    public void testSingleUpdate()
    {
        ...
        String sql = "select * from " + getSchemaName() + ".ALL_TYPES where ID = "+9876;
        validateMithraResult(op, sql);
    }
...
//            System.out.println("took "+(System.currentTimeMillis() - start)+" ms");
    ...
    public void testMultiUpdate()
    {
        ...
        String sql = "select * from " + getSchemaName() + ".ALL_TYPES where BOOL_COL = "+0;
    ...
    public void testBatchDelete()
    {
        ...
        String sql = "select * from " + getSchemaName() + ".ALL_TYPES where BOOL_COL = "+1;
