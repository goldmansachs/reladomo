...
public class MithraSybaseTestAbstract extends MithraTestAbstract
{
    private MithraTestResource mithraTestResource;
    private String testDataFileName = "testdata/vendor/mithraSybaseTestData.txt";
    ...
    throws Exception
    {
        ...
        mithraTestResource = new MithraTestResource("MithraSybaseTestConfig.xml", SybaseDatabaseType.getInstance());
    ...
    protected void tearDown() throws Exception
    {
        ...
        if (!SybaseTestConnectionManager.getInstance().ensureAllConnectionsReturnedToPool())
        {
    ...
    {
        return SybaseTestConnectionManager.getInstance().getConnection();
    }
    ...
    protected TestAcctEntitySegmentList createNewMilestonedObjectList(Timestamp businessDate, int firstId, long count)
    {
        TestAcctEntitySegmentList list = new TestAcctEntitySegmentList();
        for(int i = firstId; i < (firstId + count); i++)
        {
            TestAcctEntitySegment obj = new TestAcctEntitySegment(businessDate);
            obj.setAccountId("" + i);
            obj.setSegmentId(i);
    ...
    protected AllTypes createNewAllTypes(int id, boolean withNullablesNull)
    {
        ...
        else
        {
            ...
            allTypesObj.setNullableTimeValue(Time.withMillis(1, 1, 1, 10));
        ...
        allTypesObj.setTimeValue(Time.withMillis(1, 1, 1, 10));
