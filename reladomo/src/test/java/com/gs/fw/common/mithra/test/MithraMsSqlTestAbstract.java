...
public class MithraMsSqlTestAbstract extends MithraTestAbstract
{
    private MithraTestResource mithraTestResource;
    private String testDataFileName = "testdata/vendor/mithraMsSqlTestData.txt";
    ...
    throws Exception
    {
        ...
        mithraTestResource = new MithraTestResource("MithraMsSqlTestConfig.xml", MsSqlDatabaseType.getInstance());
        mithraTestResource.setRestrictedClassList(getRestrictedClassList());

        MsSqlTestConnectionManager connectionManager = MsSqlTestConnectionManager.getInstance();
    ...
    protected void tearDown() throws Exception
    {
        ...
        if (!MsSqlTestConnectionManager.getInstance().ensureAllConnectionsReturnedToPool())
        {
    ...
    {
        return MsSqlTestConnectionManager.getInstance().getConnection();
    }
    ...
    protected void validateMithraResult(MithraList list, String sql, int minSize)
      {
          ...
          {
              getLogger().error("SQLException on MithraMsSqlTestAbstract.validateMithraResult()",e);
