...
public class DateGreaterThanOperation extends NonPrimitiveGreaterThanOperation implements Externalizable
{

    public DateGreaterThanOperation(Attribute attribute, Date parameter)
    {
        super(attribute, parameter);
    }

    public DateGreaterThanOperation()
    {
        // for Externalizable
    }
