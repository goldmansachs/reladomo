...
public class ShortGreaterThanOperation extends GreaterThanOperation
{

    private short parameter;

    public ShortGreaterThanOperation(Attribute attribute, short parameter)
    {
        super(attribute);
    ...
    public Operation zCombinedAndWithAtomicGreaterThan(GreaterThanOperation op)
    {
        if (op.getAttribute().equals(this.getAttribute()))
        {
            int target = ((ShortGreaterThanOperation) op).getParameter();
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof ShortGreaterThanOperation)
        {
            ShortGreaterThanOperation other = (ShortGreaterThanOperation) obj;
