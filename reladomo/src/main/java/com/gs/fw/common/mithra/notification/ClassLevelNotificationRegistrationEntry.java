...
{
    static private final Logger logger = LoggerFactory.getLogger(ClassLevelNotificationRegistrationEntry.class.getName());
    private MithraApplicationClassLevelNotificationListener listener;

    public ClassLevelNotificationRegistrationEntry(MithraApplicationClassLevelNotificationListener listener)
    {
    ...
    public void processNotification(MithraNotificationEvent notificationEvent)
    {
        ...
        this.listener.processNotificationEvent(notificationEvent);
    }
}
