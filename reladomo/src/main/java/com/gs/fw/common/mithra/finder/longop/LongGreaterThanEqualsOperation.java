...
public class LongGreaterThanEqualsOperation extends GreaterThanEqualsOperation implements OpWithLongParam
{

    private long parameter;

    public LongGreaterThanEqualsOperation(Attribute attribute, long parameter)
    {
        super(attribute);
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof LongGreaterThanEqualsOperation)
        {
            LongGreaterThanEqualsOperation other = (LongGreaterThanEqualsOperation) obj;
