...
public class ByteGreaterThanOperation extends GreaterThanOperation implements OpWithByteParam
{
    ...
    public ByteGreaterThanOperation(Attribute attribute, byte parameter)
    {
        super(attribute);
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof ByteGreaterThanOperation)
        {
            ByteGreaterThanOperation other = (ByteGreaterThanOperation) obj;
