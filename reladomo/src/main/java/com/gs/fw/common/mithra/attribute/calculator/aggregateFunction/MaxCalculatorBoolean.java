...
public class MaxCalculatorBoolean extends AbstractAggregateAttributeCalculator implements BooleanProcedure
{
    private static final long serialVersionUID = -4236897973601804678L;
    private BooleanAttribute attribute;

    public MaxCalculatorBoolean(BooleanAttribute attribute)
    {
        super("max");
        this.attribute = attribute;
    }

    public MaxCalculatorBoolean()
    {
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof MaxCalculatorBoolean)) return false;

        MaxCalculatorBoolean that = (MaxCalculatorBoolean) o;
