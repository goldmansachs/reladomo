...
public class PartialDatedTransactionalCache extends AbstractDatedTransactionalCache implements ReferenceListener
{
    ...
    public PartialDatedTransactionalCache(Attribute[] nonDatedPkAttributes, AsOfAttribute[] asOfAttributes,
    ...
    {
        return new TransactionalPartialSemiUniqueDatedIndex(indexName, extractors, asOfAttributes, timeToLive, relationshipTimeToLive);
    }
