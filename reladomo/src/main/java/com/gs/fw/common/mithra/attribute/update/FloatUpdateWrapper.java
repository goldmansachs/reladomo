...
public class FloatUpdateWrapper extends AttributeUpdateWrapper implements FloatExtractor
{

    private float newValue;

    public FloatUpdateWrapper(Attribute attribute, MithraDataObject dataToUpdate, float newValue)
    {
        super(attribute, dataToUpdate);
        this.newValue = newValue;
    }

    public FloatUpdateWrapper()
    {
    }

    public boolean hasSameParameter(AttributeUpdateWrapper other)
    {
        return other instanceof FloatUpdateWrapper && this.newValue == ((FloatUpdateWrapper)other).newValue;
    }
    ...
    {
        ((FloatAttribute)this.getAttribute()).setFloatValue(data, newValue);
    }
