...
public class PartialCacheMithraNotificationListener extends AbstractNonDatedMithraNotificationListener
{

    public PartialCacheMithraNotificationListener(MithraObjectPortal mithraObjectPortal)
    {
        super(mithraObjectPortal);
    }
    public void onInsert(MithraDataObject[] mithraDataObject, Object sourceAttribute)
    {
