...
public class DatedPersistedTxEnrollBehavior extends DatedPersistedBehavior
{
    public DatedPersistedTxEnrollBehavior()
    {
    ...
    {
        if (mithraObject.zGetCache().enrollDatedObject(mithraObject, prevState, false))
        {
    ...
    {
        if (mithraObject.zGetCache().enrollDatedObject(mithraObject, prevState, true))
        {
            return AbstractDatedTransactionalBehavior.getPersistedSameTxBehavior();
        }
        return null;
    ...
    {
        if (mithraObject.zGetCache().enrollDatedObjectForDelete(mithraObject, prevState, true))
        {
            return AbstractDatedTransactionalBehavior.getPersistedSameTxBehavior();
        }
        return null;
