...
public class ShortTupleExtractor extends AbstractShortExtractor<Tuple>
{
    ...
    public ShortTupleExtractor(int pos)
    {
        this.pos = pos;
    }

    public short shortValueOf(Tuple o)
    {
        return o.getAttributeAsShort(this.pos);
    }
    ...
    public void setShortValue(Tuple o, short newValue)
    {
