...
public interface NumericType
{
    ...
    public NumericAttribute createCalculatedAttribute(NumericAttributeCalculator calculator);
    public NumericAttribute createMappedCalculatedAttribute(NumericAttribute wrappedAttribute, Mapper mapper, Function parentSelector);
