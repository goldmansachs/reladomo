...
public class FullDatedCacheMithraNotificationListener extends AbstractDatedMithraNotificationListener
{

    public FullDatedCacheMithraNotificationListener(MithraObjectPortal mithraObjectPortal)
    {
    ...
    {
        readObjectsFromDatabase(mithraDataObjects, sourceAttributeValue);
