...
public class MinCalculatorTime extends AbstractAggregateAttributeCalculator implements TimeProcedure
{
    private static final long serialVersionUID = 0L;

    private TimeAttribute attribute;

    public MinCalculatorTime(TimeAttribute attribute)
    {
        super("min");
        this.attribute = attribute;
    }

    public MinCalculatorTime()
    {
    }
    ...
    public int hashCode()
    {
        return this.attribute.hashCode() ^ 0x3548FC08;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof MinCalculatorTime)) return false;

        MinCalculatorTime that = (MinCalculatorTime) o;
