...
public class NonPrimitiveGreaterThanOperation extends GreaterThanOperation
{

    private Comparable parameter;

    public NonPrimitiveGreaterThanOperation(Attribute attribute, Comparable parameter)
    {
        super(attribute);
        this.parameter = parameter;
    }

    public NonPrimitiveGreaterThanOperation()
    {
        // for externalizable
    }
    ...
    protected Comparable getParameter()
    {
        return parameter;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof NonPrimitiveGreaterThanOperation)
        {
            NonPrimitiveGreaterThanOperation other = (NonPrimitiveGreaterThanOperation) obj;
