...
public class DeleteAllTransactionalCommand implements TransactionalCommand
{
    ...
    public DeleteAllTransactionalCommand(DelegatingList delegatingList, AbstractTransactionalOperationBasedList abstractTransactionalOperationBasedList)
    {
