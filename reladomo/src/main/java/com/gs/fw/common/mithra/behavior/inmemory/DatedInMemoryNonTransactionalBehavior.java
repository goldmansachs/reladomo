...
public class DatedInMemoryNonTransactionalBehavior extends DatedInMemoryBehavior
{
    public DatedInMemoryNonTransactionalBehavior()
    {
    ...
    {
        throw new MithraBusinessException("In memory non-transactional objects cannot be inserted!");
    }
