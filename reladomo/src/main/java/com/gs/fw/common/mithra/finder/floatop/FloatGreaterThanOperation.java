...
public class FloatGreaterThanOperation extends GreaterThanOperation implements OpWithFloatParam
{

    private float parameter;

    public FloatGreaterThanOperation(Attribute attribute, float parameter)
    {
        super(attribute);
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof FloatGreaterThanOperation)
        {
            FloatGreaterThanOperation other = (FloatGreaterThanOperation) obj;
