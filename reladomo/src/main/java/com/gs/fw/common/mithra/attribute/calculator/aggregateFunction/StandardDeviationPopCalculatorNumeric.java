...
public class StandardDeviationPopCalculatorNumeric extends AbstractAggregateAttributeCalculator
        implements DoubleProcedure, BigDecimalProcedure, FloatProcedure, LongProcedure, IntegerProcedure
{
    ...
    public StandardDeviationPopCalculatorNumeric(NumericAttribute attribute)
    {
        super(null);
    ...
    protected StandardDeviationPopCalculatorNumeric(String sqlFunction)
    {
        super(sqlFunction);
    }
    ...
    {
        return "(" + query.getDatabaseType().getSqlExpressionForStandardDeviationPop(attribute.getFullyQualifiedLeftHandExpression(query)) + "), count(1)";
    }
    ...
    public Object aggregate(Object previousValue, Object newValue)
    {
        ...
        {
            previousValue = new MutableStandardDeviationPop();
        }
    ...
    {
        MutableStandardDeviationPop result = (MutableStandardDeviationPop) context;
        result.add(object);
        return false;
    }
    ...
    public int hashCode()
    {
        return this.attribute.hashCode() ^ 0x33A5BD6;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof StandardDeviationPopCalculatorNumeric)) return false;

        StandardDeviationPopCalculatorNumeric that = (StandardDeviationPopCalculatorNumeric) o;
