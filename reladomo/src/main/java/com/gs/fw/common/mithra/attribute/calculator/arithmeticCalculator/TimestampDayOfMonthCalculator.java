...
public class TimestampDayOfMonthCalculator extends SingleAttributeNumericCalculator<TimestampAttribute>
{
    public TimestampDayOfMonthCalculator(TimestampAttribute timestampAttribute)
    {
    ...
    public String getFullyQualifiedCalculatedExpression(SqlQuery query)
    {
        ...
        return "(" + query.getDatabaseType().getSqlExpressionForTimestampDayOfMonth(attribute.getFullyQualifiedLeftHandExpression(query), conversion, query.getTimeZone()) + ")";
    }
