...
public class DatedInMemoryState extends DatedPersistenceState
{

    public DatedTransactionalBehavior getForNoTransaction()
    {
        return AbstractDatedTransactionalBehavior.getInMemoryNoTxBehavior();
    }

    public DatedTransactionalBehavior getForSameTransaction()
    {
        return AbstractDatedTransactionalBehavior.getInMemorySameTxBehavior();
    }

    public DatedTransactionalBehavior getForDifferentTransaction()
    {
        return AbstractDatedTransactionalBehavior.getInMemoryDifferentTxBehavior();
    }

    public DatedTransactionalBehavior getForEnrollTransaction()
    {
        return AbstractDatedTransactionalBehavior.getInMemoryTxEnrollBehavior();
    }

    public DatedTransactionalBehavior getForThreadNoObjectYesTransaction()
    {
        return AbstractDatedTransactionalBehavior.getInMemoryThreadNoTxObjectTxBehavior();
    }
}
