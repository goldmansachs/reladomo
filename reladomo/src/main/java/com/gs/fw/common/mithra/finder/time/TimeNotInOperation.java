...
public class TimeNotInOperation extends NonPrimitiveNotInOperation implements Externalizable
{
    public TimeNotInOperation(NonPrimitiveAttribute attribute, Set set)
    {
        super(attribute, set);
    }

    public TimeNotInOperation()
    {
        // for externalizable
    }
