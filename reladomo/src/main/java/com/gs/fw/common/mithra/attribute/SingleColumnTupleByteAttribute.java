...
public class SingleColumnTupleByteAttribute<Owner> extends SingleColumnByteAttribute<Owner>
{
    ...
    public SingleColumnTupleByteAttribute(int pos, boolean isNullable, TupleTempContext tupleTempContext)
    {
    ...
    public byte byteValueOf(Owner o)
    {
        return ((Tuple)o).getAttributeAsByte(this.pos);
    }

    public void setByteValue(Owner o, byte newValue)
    {
        throw new RuntimeException("not implemented");
    }
