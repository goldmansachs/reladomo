...
public class MaxCalculatorCharacter extends AbstractAggregateAttributeCalculator implements CharacterProcedure
{
    ...
    public MaxCalculatorCharacter(CharAttribute attribute)
    {
        super("max");
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof MaxCalculatorCharacter)) return false;

        MaxCalculatorCharacter that = (MaxCalculatorCharacter) o;
