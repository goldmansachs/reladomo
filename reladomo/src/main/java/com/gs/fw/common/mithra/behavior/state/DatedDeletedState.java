...
public class DatedDeletedState extends DatedPersistenceState
{

    public DatedTransactionalBehavior getForNoTransaction()
    {
        return AbstractDatedTransactionalBehavior.getDefaultDeletedBehavior();
    }
    ...
    {
        return AbstractDatedTransactionalBehavior.getDeletedDifferentTxBehavior();
    }
    ...
    {
        return AbstractDatedTransactionalBehavior.getDeletedThreadNoTxObjectTxBehavior();
    }
}
