...
public class IntegerLessThanOperation extends LessThanOperation implements OpWithIntParam
{

    private int parameter;

    public IntegerLessThanOperation(Attribute attribute, int parameter)
    {
        super(attribute);
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof IntegerLessThanOperation)
        {
            IntegerLessThanOperation other = (IntegerLessThanOperation) obj;
