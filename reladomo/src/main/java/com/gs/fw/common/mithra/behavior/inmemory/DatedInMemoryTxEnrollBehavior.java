...
public class DatedInMemoryTxEnrollBehavior extends DatedInMemoryBehavior
{
    protected DatedInMemoryTxEnrollBehavior(byte persistenceState, boolean isDetached, boolean maySetPrimaryKey)
    {
        super(persistenceState, DATA_GET_OR_ALLOCATE, DATA_UNEXPECTED, isDetached, maySetPrimaryKey);
    }

    public DatedInMemoryTxEnrollBehavior()
    {
