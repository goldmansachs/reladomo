...
public class PersistedThreadNoTxObjectTxBehavior extends PersistedBehavior
{

    public PersistedThreadNoTxObjectTxBehavior()
    {
    ...
    {
        // we can get here if this object is read from the db between the time a tx was committed and the objects are committed
