...
public class DeletedState extends PersistenceState
{

    public TransactionalBehavior getForNoTransaction()
    {
        return AbstractTransactionalBehavior.getDefaultDeletedBehavior();
    }
    ...
    {
        return AbstractTransactionalBehavior.getDeletedDifferentTxBehavior();
    }
    ...
    {
        return AbstractTransactionalBehavior.getDeletedThreadNoTxObjectTxBehavior();
    }
}
