...
public class SingleColumnTupleCharAttribute<Owner> extends SingleColumnCharAttribute<Owner>
{
    ...
    public SingleColumnTupleCharAttribute(int pos, boolean isNullable, TupleTempContext tupleTempContext)
    {
    ...
    @Override
    public void setValue(Owner o, Character newValue)
    {
    ...
    public char charValueOf(Owner o)
    {
        return ((Tuple)o).getAttributeAsChar(this.pos);
    }

    public void setCharValue(Owner o, char newValue)
    {
        throw new RuntimeException("not implemented");
    }
