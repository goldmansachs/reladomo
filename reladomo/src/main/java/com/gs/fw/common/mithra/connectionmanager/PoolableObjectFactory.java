 ...
 * instances to be served by an {@link ObjectPoolWithThreadAffinity}.
 * <p>
 * By contract, when an {@link ObjectPoolWithThreadAffinity}
 * delegates to a {@link com.gs.fw.common.mithra.connectionmanager.PoolableObjectFactory},
 * <ol>
 *  <li>
 ...
 *   {@link ObjectPoolWithThreadAffinity#borrowObject borrowed} from the pool.
 *  </li>
 *  <li>
 *   {@link #validateObject validateObject}
 *   is invoked on {@link #activateObject activated} instances to make sure
 *   they can be {@link ObjectPoolWithThreadAffinity#borrowObject borrowed} from the pool.
 *   <code>validateObject</code> <strong>may</strong> also be used to test an
 *   instance being {@link ObjectPoolWithThreadAffinity#returnObject returned} to the pool
 ...
 * </p>
 * <p>
 * {@link com.gs.fw.common.mithra.connectionmanager.PoolableObjectFactory} must be thread-safe. The only promise
 * an {@link ObjectPoolWithThreadAffinity} makes is that the same instance of an object will not
 * be passed to more than one method of a <code>PoolableObjectFactory</code>
 * at a time.
 * </p>
 *
 * @see ObjectPoolWithThreadAffinity
 *
...
public interface PoolableObjectFactory<E>
{
   ...
   */
  E makeObject(ObjectPoolWithThreadAffinity<E> pool) throws Exception;
   ...
   * @see #validateObject
   */
  void destroyObject(E obj) throws Exception;
   ...
   * @see #destroyObject
   */
  void activateObject(E obj) throws Exception;
   ...
   * @see #destroyObject
   */
  void passivateObject(E obj) throws Exception;
}
