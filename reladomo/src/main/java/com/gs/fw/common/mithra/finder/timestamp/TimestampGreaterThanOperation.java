...
public class TimestampGreaterThanOperation extends NonPrimitiveGreaterThanOperation implements Externalizable
{

    private transient long time;

    public TimestampGreaterThanOperation(Attribute attribute, Timestamp parameter)
    {
        super(attribute, parameter);
        this.time = parameter.getTime();
    }

    public TimestampGreaterThanOperation()
    {
        // for externalizable
    }
