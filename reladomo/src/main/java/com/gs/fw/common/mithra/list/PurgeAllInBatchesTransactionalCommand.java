...
public class PurgeAllInBatchesTransactionalCommand extends DeleteAllInBatchesTransactionalCommand
{
    ...
    public PurgeAllInBatchesTransactionalCommand(DelegatingList delegatingList, AbstractTransactionalOperationBasedList abstractTransactionalOperationBasedList, int[] batchSize)
    {
        super(delegatingList, abstractTransactionalOperationBasedList, batchSize);
    }
