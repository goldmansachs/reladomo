...
public class IntegerToStringCalculator implements StringAttributeCalculator
{

    private IntegerAttribute attribute;

    public IntegerToStringCalculator(IntegerAttribute attribute)
    {
    ...
    {
        if (this.attribute.isAttributeNull(o))
        {
            return null;
        }
        return String.valueOf(this.attribute.intValueOf(o));
    }

    @Override
    public SingleColumnAttribute createTupleAttribute(int pos, TupleTempContext tupleTempContext)
    {
        return new SingleColumnTupleStringAttribute(pos, 11, tupleTempContext, true); // 11 is length of -2^31
    }
    ...
    {
        return query.getDatabaseType().getConversionFunctionIntegerToString(this.attribute.getFullyQualifiedLeftHandExpression(query));
    }

    public void appendToString(ToStringContext toStringContext)
    {
        toStringContext.append("toString(");
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof IntegerToStringCalculator)
        {
            return this.attribute.equals(((IntegerToStringCalculator)obj).attribute);
        }
        return false;
    }
    ...
    public int hashCode()
    {
        return 0x87654321 ^ this.attribute.hashCode();
    }
}
