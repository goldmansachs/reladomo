...
public class NonPrimitiveLessThanOperation extends LessThanOperation implements OpWithObjectParam
{
    ...
    public NonPrimitiveLessThanOperation(Attribute attribute, Comparable parameter)
    {
        super(attribute);
    ...
    public int hashCode()
    {
        return this.getAttribute().hashCode() ^ this.parameter.hashCode() ^ 0xA0A0A0;
    }

    public boolean equals(Object obj)
    {
        if (obj == this) return true;
        if (obj instanceof NonPrimitiveLessThanOperation)
        {
            NonPrimitiveLessThanOperation other = (NonPrimitiveLessThanOperation) obj;
