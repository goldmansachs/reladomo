...
public class TimeGreaterThanOperation extends NonPrimitiveGreaterThanOperation implements Externalizable
{
    private transient long time;

    public TimeGreaterThanOperation(Attribute attribute, Time parameter)
    {
