...
public class TimestampGreaterThanEqualsOperation extends NonPrimitiveGreaterThanEqualsOperation implements Externalizable
{

    private transient long time;

    public TimestampGreaterThanEqualsOperation(Attribute attribute, Timestamp parameter)
    {
        super(attribute, parameter);
        this.time = parameter.getTime();
    }

    public TimestampGreaterThanEqualsOperation()
    {
        // for externalizable
    }
