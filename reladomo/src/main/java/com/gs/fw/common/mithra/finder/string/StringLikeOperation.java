...
public abstract class StringLikeOperation extends AbstractAtomicOperation
{

    private String parameter;

    protected StringLikeOperation(StringAttribute attribute, String parameter)
    {
        super(attribute);
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof StringLikeOperation && obj.getClass() == this.getClass())
        {
            StringLikeOperation other = (StringLikeOperation) obj;
...
//        if (!(op instanceof StringLikeOperation)) return op.zCombinedAnd(this);
    ...
    {
        // todo: rezaem: implements combine with atomic; the result is either the equality op or NoneOperation
        return null;
    }
    ...
    public void generateSql(SqlQuery query)
    {
        ...
        query.appendWhereClause(this.getAttribute().getFullyQualifiedLeftHandExpression(query)+" like ?"+escape);
