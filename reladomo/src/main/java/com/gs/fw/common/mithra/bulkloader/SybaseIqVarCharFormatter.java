...
public class SybaseIqVarCharFormatter extends SybaseIqOutputFormatter
{

    private int length;

    public SybaseIqVarCharFormatter(boolean nullable, String columnName, int length)
    {
        super(nullable, columnName, "varchar");
        this.length = length;
    }
