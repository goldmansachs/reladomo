...
public class DatedPersistedThreadNoTxObjectTxBehavior extends DatedPersistedBehavior
{
    public DatedPersistedThreadNoTxObjectTxBehavior()
    {
        super(DATA_USE_NON_TX, DATA_UNEXPECTED, true);
    }
