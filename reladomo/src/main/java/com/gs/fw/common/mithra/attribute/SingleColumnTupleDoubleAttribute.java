...
public class SingleColumnTupleDoubleAttribute<Owner> extends SingleColumnDoubleAttribute<Owner>
{
    ...
    public SingleColumnTupleDoubleAttribute(int pos, boolean isNullable, TupleTempContext tupleTempContext)
    {
    ...
    @Override
    public void setValue(Owner o, Double newValue)
    {
    ...
    public double doubleValueOf(Owner o)
    {
        return ((Tuple)o).getAttributeAsDouble(this.pos);
    }

    public void setDoubleValue(Owner o, double newValue)
    {
        throw new RuntimeException("not implemented");
    }
