...
public class DateLessThanOperation extends NonPrimitiveLessThanOperation implements Externalizable
{

    public DateLessThanOperation(Attribute attribute, Date parameter)
    {
        super(attribute, parameter);
    }

    public DateLessThanOperation()
    {
        // for Externalizable
    }
