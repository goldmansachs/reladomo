...
public class DoubleGreaterThanEqualsOperation extends GreaterThanEqualsOperation
{

    private double parameter;

    public DoubleGreaterThanEqualsOperation(Attribute attribute, double parameter)
    {
        super(attribute);
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof DoubleGreaterThanEqualsOperation)
        {
            DoubleGreaterThanEqualsOperation other = (DoubleGreaterThanEqualsOperation) obj;
