...
public class TimeGreaterThanEqualsOperation extends NonPrimitiveGreaterThanEqualsOperation implements Externalizable
{
    private transient long time;

    public TimeGreaterThanEqualsOperation(Attribute attribute, Time parameter)
    {
        super(attribute, parameter);
        this.time = parameter.getTime();
    }

    public TimeGreaterThanEqualsOperation()
    {
        // for externalizable
    }
