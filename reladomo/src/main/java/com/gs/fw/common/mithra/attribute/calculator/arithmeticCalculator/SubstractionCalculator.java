...
public class SubstractionCalculator extends AbstractArithmeticAttributeCalculator
{
    ...
    public SubstractionCalculator(NumericAttribute attribute1, NumericAttribute attribute2)
    {
    ...
    public int getPrecision()
    {
        ...
        return BigDecimalUtil.calculateSubstractionPrecision(precision1, scale1, precision2, scale2);
    }
    ...
    {
        return (new BigDecimal((String.valueOf(this.getAttribute1().valueOf(o)))).subtract(new BigDecimal(String.valueOf(this.getAttribute2().valueOf(o))))) ;
    }
    ...
    private static class InnerBigDecimalProcedure implements BigDecimalProcedure
    {
        ...
        public boolean execute(BigDecimal object, Object context)
        {
            ...
            proc.execute(doubleAndContext.getValue().subtract(object), doubleAndContext.getContext());
            return false;
        }
