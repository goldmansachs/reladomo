...
public class FullDatedCache extends AbstractDatedCache
{
    ...
    public FullDatedCache(Attribute[] nonDatedPkAttributes, AsOfAttribute[] asOfAttributes, MithraDatedObjectFactory factory, Attribute[] immutableAttributes)
    {
    ...
    {
        return new LazyIndex(new NonUniqueIndex(indexName, this.getPrimaryKeyAttributes(), extractors));
    }
