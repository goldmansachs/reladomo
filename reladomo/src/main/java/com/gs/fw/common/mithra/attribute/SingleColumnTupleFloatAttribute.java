...
public class SingleColumnTupleFloatAttribute<Owner> extends SingleColumnFloatAttribute<Owner>
{
    ...
    public SingleColumnTupleFloatAttribute(int pos, boolean isNullable, TupleTempContext tupleTempContext)
    {
    ...
    @Override
    public void setValue(Owner o, Float newValue)
    {
    ...
    public float floatValueOf(Owner o)
    {
        return ((Tuple)o).getAttributeAsFloat(this.pos);
    }

    public void setFloatValue(Owner o, float newValue)
    {
        throw new RuntimeException("not implemented");
    }
