...
public class StringWildCardNotEqOperation extends StringNotLikeOperation
{
    private static final long serialVersionUID = -2531503578551325678L;

    private final WildcardParser parser;

    public StringWildCardNotEqOperation(StringAttribute attribute, String pattern)
    {
    ...
    public void zToString(ToStringContext toStringContext)
    {
        ...
        toStringContext.append("not wildCardEquals").append("\""+this.getParameter()+"\"");
    }
