...
//    public void broadcastNotificationMessage(Map notificationEvents);
    ...
    public void addMithraNotificationEventForUpdate(String databaseIdentifier, String classname, byte databaseOperation,
                                     MithraDataObject mithraDataObject, AttributeUpdateWrapper updateWrapper, Object sourceAttribute);
    ...
    public void addMithraNotificationEventForBatchUpdate(String databaseIdentifier, String classname, byte databaseOperation,
                                     List updateOperations, List updateWrappers, Object sourceAttribute);

    public void addMithraNotificationEventForMultiUpdate(String databaseIdentifier, String classname, byte databaseOperation,
                                     MultiUpdateOperation multiUpdateOperation, Object sourceAttribute);
