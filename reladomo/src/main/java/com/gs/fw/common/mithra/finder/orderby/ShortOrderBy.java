...
public class ShortOrderBy extends AttributeBasedOrderBy
{
    ...
    public ShortOrderBy(Attribute attribute, boolean ascending)
    {
    ...
    {
        int leftInt = ((ShortAttribute)this.getAttribute()).shortValueOf(left);
        int rightInt = ((ShortAttribute)this.getAttribute()).shortValueOf(right);
