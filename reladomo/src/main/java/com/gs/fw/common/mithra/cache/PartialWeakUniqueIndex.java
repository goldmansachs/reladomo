...
public class PartialWeakUniqueIndex implements PrimaryKeyIndex, UnderlyingObjectGetter
{
     ...
     */
    public PartialWeakUniqueIndex(String indexName, Extractor[] extractors, int initialCapacity, float loadFactor)
    {
     ...
     * @throws IllegalArgumentException If the initial capacity is negative.
     */
    public PartialWeakUniqueIndex(String indexName, Extractor[] extractors, int initialCapacity)
    {
     ...
     */
    public PartialWeakUniqueIndex(String indexName, Extractor[] extractors)
    {
        this.extractors = extractors;
        hashStrategy = ExtractorBasedHashStrategy.create(this.extractors);
    ...
    public PartialWeakUniqueIndex(String indexName, Extractor[] extractors, long timeToLive, long relationshipTimeToLive)
    {
