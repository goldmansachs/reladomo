...
public class PersistedState extends PersistenceState
{

    public TransactionalBehavior getForNoTransaction()
    {
        return AbstractTransactionalBehavior.getPersistedNoTxBehavior();
    }
    ...
    {
        return AbstractTransactionalBehavior.getPersistedDifferentTxBehavior();
    }

    public TransactionalBehavior getForEnrollTransaction()
    {
        return AbstractTransactionalBehavior.getPersistedTxEnrollBehavior();
    }

    public TransactionalBehavior getForThreadNoObjectYesTransaction()
    {
        return AbstractTransactionalBehavior.getPersistedThreadNoTxObjectTxBehavior();
    }
}
