...
public class MutableStandardDeviationPop extends MutableNumber
        implements Nullable
{
    private int count = 0;
    ...
    public MutableStandardDeviationPop()
    {
    }

    public MutableStandardDeviationPop(double mutableDouble)
    {
        this.count = 1;
    ...
    public boolean equals(Object o)
    {
        ...
        MutableStandardDeviationPop that = (MutableStandardDeviationPop) o;
