...
public class TerminateOnRemoveHandler implements DependentRelationshipRemoveHandler
{
    ...
    {
        return TerminateOnRemoveHandler.instance;
    }

    public void removeRelatedObject(MithraObject relatedObject)
    {
        ((MithraDatedTransactionalObject)relatedObject).cascadeTerminate();
    }
}
