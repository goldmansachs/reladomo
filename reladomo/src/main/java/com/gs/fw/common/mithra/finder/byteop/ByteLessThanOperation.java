...
public class ByteLessThanOperation extends LessThanOperation implements OpWithByteParam
{
    ...
    public ByteLessThanOperation(Attribute attribute, byte parameter)
    {
        super(attribute);
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof ByteLessThanOperation)
        {
            ByteLessThanOperation other = (ByteLessThanOperation) obj;
