...
public class SingleColumnTupleIntegerAttribute<Owner> extends SingleColumnIntegerAttribute<Owner>
{
    ...
    public SingleColumnTupleIntegerAttribute(int pos, boolean isNullable, TupleTempContext tupleTempContext)
    {
    ...
    @Override
    public void setValue(Owner o, Integer newValue)
    {
    ...
    public int intValueOf(Owner o)
    {
        return ((Tuple)o).getAttributeAsInt(this.pos);
    }

    public void setIntValue(Owner o, int newValue)
    {
        throw new RuntimeException("not implemented");
    }
