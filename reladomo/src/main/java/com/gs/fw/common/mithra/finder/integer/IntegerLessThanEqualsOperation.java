...
public class IntegerLessThanEqualsOperation extends LessThanEqualsOperation implements OpWithIntParam
{

    private int parameter;

    public IntegerLessThanEqualsOperation(Attribute attribute, int parameter)
    {
        super(attribute);
    ...
    public int hashCode()
    {
        return this.getAttribute().hashCode() ^ this.parameter ^ 0x0A0A0A;
    }

    public boolean equals(Object obj)
    {
        if (obj == this) return true;
        if (obj instanceof IntegerLessThanEqualsOperation)
        {
            IntegerLessThanEqualsOperation other = (IntegerLessThanEqualsOperation) obj;
    ...
    {
        return extractor.isAttributeNull(holder) ? false : ((IntExtractor)extractor).intValueOf(holder) <= this.getParameter();
    }
}
