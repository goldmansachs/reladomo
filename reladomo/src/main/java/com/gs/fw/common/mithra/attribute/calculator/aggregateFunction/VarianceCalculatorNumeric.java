...
import com.gs.fw.common.mithra.util.MutableVariance;
import com.gs.fw.common.mithra.util.Nullable;


public class VarianceCalculatorNumeric extends AbstractAggregateAttributeCalculator
        implements DoubleProcedure, BigDecimalProcedure, FloatProcedure, LongProcedure, IntegerProcedure
{
    ...
    public VarianceCalculatorNumeric(NumericAttribute attribute)
    {
        super(null);
        this.attribute = attribute;
    }

    public VarianceCalculatorNumeric()
    {
    }

    protected VarianceCalculatorNumeric(String sqlFunction)
    {
        super(sqlFunction);
    }
    ...
    {
        return "(" + query.getDatabaseType().getSqlExpressionForVarianceSample(attribute.getFullyQualifiedLeftHandExpression(query)) + "), count(1)";
    }
    ...
    public int populateValueFromResultSet(int resultSetPosition, int dataPosition, ResultSet rs, AggregateData data, TimeZone databaseTimezone, DatabaseType dt) throws SQLException
    {
        ...
        {
            dt.fixSampleVariance(obj, count);
        }
    ...
    public Object aggregate(Object previousValue, Object newValue)
    {
        ...
        {
            previousValue = new MutableVariance();
        }
    ...
    {
        MutableVariance result = (MutableVariance) context;
        result.add(object);
        return false;
    }
    ...
    public int hashCode()
    {
        return this.attribute.hashCode() ^ 0x5546D68;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof VarianceCalculatorNumeric)) return false;

        VarianceCalculatorNumeric that = (VarianceCalculatorNumeric) o;
