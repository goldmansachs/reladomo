...
public class MutableVariance extends MutableNumber
        implements Nullable
{
    private int count = 0;
    ...
    public MutableVariance()
    {
    }

    public MutableVariance(double mutableDouble)
    {
        this.count = 1;
    ...
    public boolean equals(Object o)
    {
        ...
        MutableVariance that = (MutableVariance) o;
