...
public interface TransactionalBehaviorChooser
{
    ...
    public TransactionalBehavior getTransactionalBehaviorForReadWithWaitIfNecessary(MithraTransactionalObject mithraTransactionalObject,
            TransactionalState transactionalState, int persistenceState);

    public TransactionalBehavior getTransactionalBehaviorForWriteWithWaitIfNecessary(MithraTransactionalObject mithraTransactionalObject,
            TransactionalState transactionalState, int persistenceState);
}
