...
public class MultiplicationCalculator extends AbstractArithmeticAttributeCalculator
{
    private static final long serialVersionUID = 2242602978188446655L;

    public MultiplicationCalculator(NumericAttribute attribute1, NumericAttribute attribute2)
    {
    ...
    public int getScale()
    {
        return getAttribute1().getScale() + getAttribute2().getScale();
    }

    public int getPrecision()
    {
        return getAttribute1().getPrecision() + getAttribute2().getPrecision();
    }
    ...
    {
        return (new BigDecimal((String.valueOf(this.getAttribute1().valueOf(o)))).multiply(new BigDecimal(String.valueOf(this.getAttribute2().valueOf(o))))) ;
    }
    ...
    private static class InnerBigDecimalProcedure implements BigDecimalProcedure
    {
        ...
        {
            BigDecimalAndContext doubleAndContext = (BigDecimalAndContext) context;
            proc.execute(doubleAndContext.getValue().multiply(object), doubleAndContext.getContext());
            return false;
        }
