...
public class DateGreaterThanEqualsOperation extends NonPrimitiveGreaterThanEqualsOperation implements Externalizable
{

    public DateGreaterThanEqualsOperation()
    {
        // for Externalizable
    }
