...
import com.gs.fw.common.mithra.util.MutableVariancePop;
import com.gs.fw.common.mithra.util.Nullable;


public class VariancePopCalculatorNumeric extends AbstractAggregateAttributeCalculator
        implements DoubleProcedure, BigDecimalProcedure, FloatProcedure, LongProcedure, IntegerProcedure
{
    ...
    public VariancePopCalculatorNumeric(NumericAttribute attribute)
    {
        super(null);
        this.attribute = attribute;
    }

    public VariancePopCalculatorNumeric()
    {
    }

    protected VariancePopCalculatorNumeric(String sqlFunction)
    {
        super(sqlFunction);
    }
    ...
    {
        return "(" + query.getDatabaseType().getSqlExpressionForVariancePop(attribute.getFullyQualifiedLeftHandExpression(query)) + "), count(1)";
    }
    ...
    public Object aggregate(Object previousValue, Object newValue)
    {
        ...
        {
            previousValue = new MutableVariancePop();
        }
    ...
    {
        MutableVariancePop result = (MutableVariancePop) context;
        result.add(object);
        return false;
    }
    ...
    public int hashCode()
    {
        return this.attribute.hashCode() ^ 0x8AE075;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof VariancePopCalculatorNumeric)) return false;

        VariancePopCalculatorNumeric that = (VariancePopCalculatorNumeric) o;
