...
public class BigDecimalLessThanOperation extends NonPrimitiveLessThanOperation
{
    public BigDecimalLessThanOperation()
    {
        super();
    }

    public BigDecimalLessThanOperation(Attribute attribute, Comparable parameter)
    {
