...
public class DatedInMemoryDifferentTxBehavior extends DatedInMemoryBehavior
{
    public DatedInMemoryDifferentTxBehavior()
    {
        super(DATA_UNEXPECTED, DATA_UNEXPECTED);
    }
