...
public class TransactionalPartialUniqueIndexWithWeakBacking extends TransactionalUniqueIndex
{
    ...
    public TransactionalPartialUniqueIndexWithWeakBacking(String indexName, Extractor[] extractors, long timeToLive, long relationshipTimeToLive)
    {
    ...
    {
        return new PartialPrimaryKeyIndex(indexName, extractors, timeToLive, relationshipTimeToLive);
    }
}
