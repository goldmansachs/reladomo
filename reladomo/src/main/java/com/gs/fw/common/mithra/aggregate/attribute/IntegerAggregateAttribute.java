...
public class IntegerAggregateAttribute extends AggregateAttribute
{

    public IntegerAggregateAttribute(){}

    public IntegerAggregateAttribute(AggregateAttributeCalculator calculator)
    {
        super(calculator);
    }
