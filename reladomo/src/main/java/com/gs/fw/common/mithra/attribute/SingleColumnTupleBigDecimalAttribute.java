...
public class SingleColumnTupleBigDecimalAttribute<Owner> extends SingleColumnBigDecimalAttribute<Owner>
{
    ...
    public SingleColumnTupleBigDecimalAttribute(int pos, boolean isNullable, TupleTempContext tupleTempContext, int precision, int scale)
    {
    ...
    @Override
    public void setValue(Owner o, BigDecimal newValue)
    {
    ...
    public BigDecimal bigDecimalValueOf(Owner o)
    {
        return ((Tuple)o).getAttributeAsBigDecimal(this.pos);
    }

    public void setBigDecimalValue(Owner o, BigDecimal newValue)
    {
        throw new RuntimeException("not implemented");
    }
