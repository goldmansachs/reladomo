...
public class DatedInMemoryNoTxBehavior extends DatedInMemoryBehavior
{
    protected DatedInMemoryNoTxBehavior(byte persistenceState, boolean isDetached, boolean maySetPrimaryKey)
    {
        super(persistenceState, DATA_GET_OR_ALLOCATE, DATA_GET_OR_ALLOCATE, isDetached, maySetPrimaryKey);
    }

    public DatedInMemoryNoTxBehavior()
    {
        super(DATA_GET_OR_ALLOCATE, DATA_GET_OR_ALLOCATE);
    }
    ...
    {
        throw new RuntimeException("inserting dated objects must be performed inside a transaction");
    }
