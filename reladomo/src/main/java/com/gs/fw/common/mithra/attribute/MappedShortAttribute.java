...
public class MappedShortAttribute<T> extends ShortAttribute<T> implements MappedAttribute
{
    ...
    public MappedShortAttribute(ShortAttribute wrappedAttribute, Mapper mapper, Function parentSelector)
    {
        ...
        {
            MappedShortAttribute ma = (MappedShortAttribute) this.wrappedAttribute;
            this.mapper = new ChainedMapper(this.mapper, ma.getMapper());
            this.wrappedAttribute = (ShortAttribute) ma.getWrappedAttribute();
    ...
    {
        return new MappedShortAttribute((ShortAttribute) this.getWrappedAttribute(), mapper, parentSelector);
    }
    ...
    public short shortValueOf(Object o)
    {
        ...
        return this.wrappedAttribute.shortValueOf(result);
    }
    ...
    public void setShortValue(Object o, short newValue)
    {
        ...
        wrappedAttribute.setShortValue(result, newValue);
    }
    ...
    {
        if (other instanceof MappedShortAttribute)
        {
            MappedShortAttribute o = (MappedShortAttribute) other;
    ...
    {
        return new MappedShortAttribute(this.wrappedAttribute, mapperRemainder, mapperRemainder.getParentSelectorRemainder(((DeepRelationshipAttribute) this.parentSelector)));
    }
