...
public class DatedDetachedDeletedState extends DatedPersistenceState
{

    public DatedTransactionalBehavior getForNoTransaction()
    {
        return AbstractDatedTransactionalBehavior.getDetachedDeletedNoTxBehavior();
    }
    ...
    {
        return AbstractDatedTransactionalBehavior.getDetachedDeletedDifferentTxBehavior();
    }

    public DatedTransactionalBehavior getForEnrollTransaction()
    {
        return AbstractDatedTransactionalBehavior.getDetachedDeletedTxEnrollBehavior();
    }

    public DatedTransactionalBehavior getForThreadNoObjectYesTransaction()
    {
        return AbstractDatedTransactionalBehavior.getDetachedDeletedThreadNoTxObjectTxBehavior();
    }
