...
public class DateNotInOperation extends NonPrimitiveNotInOperation implements Externalizable
{

    public DateNotInOperation(NonPrimitiveAttribute attribute, Set set)
    {
        super(attribute, set);
    }

    public DateNotInOperation()
    {
        // for Externalizable
    }
