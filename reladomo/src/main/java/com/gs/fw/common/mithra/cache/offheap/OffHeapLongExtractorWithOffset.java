...
public class OffHeapLongExtractorWithOffset implements OffHeapLongExtractor
{
    ...
    public OffHeapLongExtractorWithOffset(int fieldOffset, int nullBitsOffset, int nullBitsPosition)
    {
    ...
    @Override
    public long longValueOf(OffHeapDataStorage dataStorage, int dataOffset)
    {
        return dataStorage.getLong(dataOffset, fieldOffset);
    }
    ...
    public int computeHashFromValue(Object key)
    {
        ...
        return HashUtil.hash(((Long)key).longValue());
    }
    ...
    public boolean valueEquals(OffHeapDataStorage dataStorage, int dataOffset, long otherDataAddress)
    {
        ...
        return longValueOf(dataStorage, dataOffset) == UNSAFE.getLong(otherDataAddress + fieldOffset);
    }
    ...
    public boolean valueEquals(OffHeapDataStorage dataStorage, int dataOffset, int secondOffset)
    {
        return isAttributeNull(dataStorage, dataOffset) ? isAttributeNull(dataStorage, secondOffset) :
                longValueOf(dataStorage, dataOffset) == longValueOf(dataStorage, secondOffset);
    }
    ...
    public boolean valueEquals(OffHeapDataStorage dataStorage, int dataOffset, Object key)
    {
        ...
        return longValueOf(dataStorage, dataOffset) == ((Long)key).longValue();
    }
    ...
    public boolean equals(OffHeapDataStorage dataStorage, int dataOffset, Object valueHolder, Extractor extractor)
    {
        ...
        return longValueOf(dataStorage, dataOffset) == ((LongExtractor)extractor).longValueOf(valueHolder);
    }
    ...
    public int computeHash(OffHeapDataStorage dataStorage, int dataOffset)
    {
        ...
        return HashUtil.hash(longValueOf(dataStorage, dataOffset));
    }
}
