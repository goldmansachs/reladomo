...
public class StringTupleExtractor extends AbstractStringExtractor<Tuple>
{
    ...
    public StringTupleExtractor(int pos)
    {
        this.pos = pos;
    }

    public String stringValueOf(Tuple o)
    {
        return o.getAttributeAsString(this.pos);
    }

    public void setStringValue(Tuple o, String newValue)
    {
