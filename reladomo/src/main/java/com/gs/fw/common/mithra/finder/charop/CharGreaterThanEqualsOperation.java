...
public class CharGreaterThanEqualsOperation extends GreaterThanEqualsOperation implements OpWithCharParam
{

    private char parameter;

    public CharGreaterThanEqualsOperation(Attribute attribute, char parameter)
    {
        super(attribute);
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof CharGreaterThanEqualsOperation)
        {
            CharGreaterThanEqualsOperation other = (CharGreaterThanEqualsOperation) obj;
