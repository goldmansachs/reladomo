...
public class NonMilestonedTopLevelLoaderFactory extends AbstractLoaderFactory
{
    @Override
    ...
    {
        Operation allOp = this.getClassController().getFinderInstance().all();
        return this.addSourceAttributeOperation(allOp, sourceAttribute);
    }
