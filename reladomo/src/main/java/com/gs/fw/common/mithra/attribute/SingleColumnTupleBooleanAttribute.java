...
public class SingleColumnTupleBooleanAttribute<Owner> extends SingleColumnBooleanAttribute<Owner>
{
    ...
    public SingleColumnTupleBooleanAttribute(int pos, boolean isNullable, TupleTempContext tupleTempContext)
    {
    ...
    @Override
    public void setValue(Owner o, Boolean newValue)
    {
    ...
    public boolean booleanValueOf(Owner o)
    {
        return ((Tuple)o).getAttributeAsBoolean(this.pos);
    }

    public void setBooleanValue(Owner o, boolean newValue)
    {
        throw new RuntimeException("not implemented");
    }
