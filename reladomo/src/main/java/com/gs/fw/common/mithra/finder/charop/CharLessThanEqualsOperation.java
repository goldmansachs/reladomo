...
public class CharLessThanEqualsOperation extends LessThanEqualsOperation
{

    private char parameter;

    public CharLessThanEqualsOperation(Attribute attribute, char parameter)
    {
        super(attribute);
    ...
    public Operation zCombinedAndWithAtomicLessThanEquals(LessThanEqualsOperation op)
    {
        if (op.getAttribute().equals(this.getAttribute()))
        {
            char target = ((CharLessThanEqualsOperation) op).getParameter();
            if (target <= this.parameter) return op;
            return this;
        }
        return null;
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof CharLessThanEqualsOperation)
        {
            CharLessThanEqualsOperation other = (CharLessThanEqualsOperation) obj;
