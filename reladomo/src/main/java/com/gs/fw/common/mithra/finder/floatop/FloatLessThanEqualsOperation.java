...
public class FloatLessThanEqualsOperation extends LessThanEqualsOperation implements OpWithFloatParam
{
    ...
    public FloatLessThanEqualsOperation(Attribute attribute, float parameter)
    {
        super(attribute);
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof FloatLessThanEqualsOperation)
        {
            FloatLessThanEqualsOperation other = (FloatLessThanEqualsOperation) obj;
