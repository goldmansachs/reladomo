...
public class StringNotEndsWithOperation extends StringNotLikeOperation
{

    public StringNotEndsWithOperation(StringAttribute attribute, String parameter)
    {
    ...
    public void zToString(ToStringContext toStringContext)
    {
        ...
        toStringContext.append("not endsWith").append("\""+this.getParameter()+"\"");
    }
