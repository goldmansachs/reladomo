...
public class DatedDetachedState extends DatedPersistenceState
{

    public DatedTransactionalBehavior getForNoTransaction()
    {
        return AbstractDatedTransactionalBehavior.getDetachedNoTxBehavior();
    }
    ...
    {
        return AbstractDatedTransactionalBehavior.getDetachedTxEnrollBehavior();
    }
