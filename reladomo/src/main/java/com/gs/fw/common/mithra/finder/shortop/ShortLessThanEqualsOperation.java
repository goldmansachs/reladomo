...
public class ShortLessThanEqualsOperation extends LessThanEqualsOperation
{

    private short parameter;

    public ShortLessThanEqualsOperation(Attribute attribute, short parameter)
    {
        super(attribute);
    ...
    public Operation zCombinedAndWithAtomicLessThanEquals(LessThanEqualsOperation op)
    {
        if (op.getAttribute().equals(this.getAttribute()))
        {
            short target = ((ShortLessThanEqualsOperation) op).getParameter();
            if (target <= this.parameter) return op;
            return this;
        }
        return null;
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof ShortLessThanEqualsOperation)
        {
            ShortLessThanEqualsOperation other = (ShortLessThanEqualsOperation) obj;
