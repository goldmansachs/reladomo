...
{
    Operation<Owner> eq(short value);

    Operation<Owner> notEq(short value);

    Operation<Owner> greaterThan(short value);

    Operation<Owner> greaterThanEquals(short value);

    Operation<Owner> lessThan(short value);

    Operation<Owner> lessThanEquals(short value);

    Operation<Owner> in(ShortSet shortSet);

    Operation<Owner> notIn(ShortSet shortSet);
    ...
    ShortAttribute<Owner> absoluteValue();
}
