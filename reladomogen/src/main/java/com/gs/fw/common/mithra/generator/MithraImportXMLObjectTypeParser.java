...
{
    private final MithraGeneratorImport mithraGeneratorImport;

    public MithraImportXMLObjectTypeParser(MithraGeneratorImport mithraGeneratorImport)
    {
        super(mithraGeneratorImport.getFilename());
