...
public class CaseSelectorMiddleParserState extends ComputedAttributeParserState
{
    public CaseSelectorMiddleParserState(ComputedAttributeParser computedAttributeParser)
    {
