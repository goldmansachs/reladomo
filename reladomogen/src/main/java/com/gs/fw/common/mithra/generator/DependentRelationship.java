...
public class DependentRelationship
{
    ...
    private AbstractAttribute attributeToSet;

    public DependentRelationship(RelationshipAttribute relationshipAttribute, AbstractAttribute attributeToSet)
    {
    ...
    public AbstractAttribute getAttributeToSet()
    {
