...
public class FunctionParameterBeginExpressionState extends ComputedAttributeParserState
{
    public FunctionParameterBeginExpressionState(ComputedAttributeParser parser)
    {
        super(parser);
    }
